...
import { LuBell, LuClock, LuMessageSquare, LuUser } from "react-icons/lu";
          ...
          <>
            {incomingRequests.length > 0 && (
              <section className="space-y-4">
                <h2 className="tet-xl font-semibold flex items-center gap-2">
            ...
            {acceptedRequests.length > 0 && (
              <section className="space-y-4">
                <h2 className="text-xl font-semibold flex items-center gap-2">
                  <LuBell className="size-5 text-success" />
                  New Connections
                </h2>
                <div className="space-y-3">
                  {acceptedRequests.map((notification) => (
                    ...
                    >
                      <div className="card-body p-4">
                        <div className="flex items-center gap-3">
                          <div className="avatar mt-1 w-10 h-10 rounded-full">
                            <img
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-xs flex items-center opacity-70">
                              <LuClock className="size-3 mr-1" />
                              Recently
                            </p>
                          </div>
                          <div className="badge badge-success">
                            <LuMessageSquare className="size-3 mr-1" />
                            New Friend
                          </div>
                        </div>
                      </div>
