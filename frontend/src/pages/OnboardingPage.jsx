          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="flex flex-col items-center justify-center space-y-4">
              ...
              <div className="flex items-center gap-2">
                <button className="btn btn-accent" onClick={handleRandomAvatar}>
                  <FaShuffle
            ...
            <div className="form-control">
              ...
              <textarea
                ...
                className="textarea textarea-bordered h-24 w-full box-border"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text">Leaning Language</span>
                </label>
                <select
            ...
            <div className="form-control">
              ...
              <div className="relative">
                <FiMapPin className="absolute top-1/2 transform -translate-y-1/2 left-3 size-5 text-base-content opacity-70 z-10" />
                <input
                  type="text"
                  name="location"
            ...
            <button className="btn btn-primary w-full" disabled={isPending}>
              {!isPending?(
                <><LuShipWheel className="size-5 mr-2" />Complete Onboarding</>
